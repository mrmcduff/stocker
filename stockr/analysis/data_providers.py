"""
Data provider classes for stock analysis.

This module implements various data providers that can be used
to fetch stock data from different sources.
"""
    ...
    def get_options_chain(self, ticker, expiration_date=None):
        ...
        Returns:
            tuple: (selected_expiration, calls_df, puts_df)
                selected_expiration: the expiration date for the call and put options data in 'YYYY-MM-DD'
